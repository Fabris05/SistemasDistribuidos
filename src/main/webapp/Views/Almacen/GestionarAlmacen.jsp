...
<html>
    <script type="text/javascript">
            function ejecutarModal(idAlmacen, accion){
                console.log("idAlmacen:", idAlmacen);
                console.log("accionButton:", accionButton);
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="frm" name="frm" action="Almacen" method="post">
                            ...
                            <button class="btn btn-success justify-content-end" onclick="ejecutarModal(1,'agregar');" style="display: flex; align-items: center;">
                            ...
                            <table class="table table-striped text-center mt-3">
                                ...
                                <c:forEach var="c" items="${requestScope.listadoAlmacen}">
                                    <tr>
                                        ...
                                        <td>${c.descripcion}</td>
                                        <td> 
                                            <button class="btn btn-danger btn-sm" onclick="if (confirm('¿Está seguro de eliminar este registro')) { ejecutarModal('${c.idAlmacen}', 'eliminar'); } else { return false; }">Eliminar</button>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
