            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- Formulario -->
                        <form id="frm" name="frm" action="Categoria" method="post">
                            ...
                            <table class="table table-striped text-center mt-3">
                                ...
                                <c:forEach var="c" items="${requestScope.listadoCategoria}">
                                    <tr>
                                        <td class="d-none">${c.idCategoria}</td>
                                        <td>${c.categoria}</td>
                                        <td>${c.descripcionCategoria}</td>
                                        <td> 
                                            <button class="btn btn-danger btn-sm" onclick="if (confirm('¿Está seguro de eliminar este registro')) { ejecutarAccionConParams('${c.idCategoria}', 'eliminar'); } else { return false; }">Eliminar</button>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
