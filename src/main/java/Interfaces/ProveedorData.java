...
public interface ProveedorData {
    ...
    void editarProveedor(String codigo, Proveedor proveedor);
    String generarID();
    ...
    public final String AGREGAR_PROVEEDOR = "INSERT INTO Proveedor(CodigoProveedor,RUC, razonSocial, proveedor, telefono, email, ubicacion, descripcion) "
            + "VALUES (?,?,?,?,?,?,?,?);";
    public final String EDITAR_PROVEEDOR="UPDATE Proveedor SET RUC=?, razonSocial=?, proveedor=?, telefono=?, email=?, ubicacion=?, descripcion=? "
            + "WHERE CodigoProveedor=?";
