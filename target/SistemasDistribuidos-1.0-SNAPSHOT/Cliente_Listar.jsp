                    ...
                    <div class="d-flex col-12 gap-2"> <!-- BUSCAR CLIENTE -->
                        ...
                        <div class="col-6">
                            <div class="d-flex col gap-2">
                                ...
                                <div class="col-1">
                                    <button type="submit" class="btn btn-primary"  onclick="ejecutarAccionConParams('${p.id}','buscar');">
                                ...
                                <div class="col-1">
                                    <button type="submit" class="btn btn-secondary" onclick="ejecutarAccionConParams('${p.id}','refrescar');">
